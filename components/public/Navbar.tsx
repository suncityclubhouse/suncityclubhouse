    ...
    <header
      className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${
        scrolled
          ...
          : "bg-white/85 backdrop-blur-sm border-b border-stone-100/60"
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-3 items-center h-16">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            <button
              className="lg:hidden p-2 -ml-1 rounded-md text-stone-600 hover:text-stone-900 transition-colors"
          ...
          <div className="flex items-center justify-end gap-3">
            {WHATSAPP && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hidden lg:flex items-center gap-1.5 text-sm text-stone-600 hover:text-stone-900 transition-colors"
              >
